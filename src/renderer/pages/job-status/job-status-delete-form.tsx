...
export default function JobStatusDeleteForm({ setRefresh }: JobStatusEditFormProps) {
  ...
  return (
    ...
    >
      ...
      >
        <DialogTitle className="text-[20px] font-bold">Delete Job Status</DialogTitle>
        ...
        <DialogFooter>
          <Button variant="delete" onClick={handleSubmit}>
            {loading ? <LoadingIcon width={22} height={22} fill="#f8fafc" className="animate-spin" /> : <span>Delete</span>}
          </Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
